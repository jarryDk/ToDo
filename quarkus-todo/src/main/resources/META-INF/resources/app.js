...
var restServiceUrl = urlResult + '/todos';
var wsServiceUrl = "wss://" + urlArr[2] + "/ws/todos";
console.info('restServiceUrl', restServiceUrl);
console.info('wsServiceUrl', wsServiceUrl);
...
function webSocketTest() {
    ...
    if ("WebSocket" in window) {
       ...
       var ws = new WebSocket(wsServiceUrl);
       ...
       ws.onmessage = function (evt) {
          ...
          console.info("Message is received... ", JSON.parse(received_msg) );
       };
       ...
       console.info("WebSocket NOT supported by your Browser!");
    }
}